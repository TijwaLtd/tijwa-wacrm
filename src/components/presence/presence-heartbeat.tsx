...
export function PresenceHeartbeat() {
  ...
  useEffect(() => {
    ...
    const beat = async () => {
      ...
      if (error && !cancelled) {
        // Non-fatal: presence is best-effort. Network failures ("Failed to
        // fetch") are common and expected; downgrade to warn so they don't
        // pollute the console as red errors.
