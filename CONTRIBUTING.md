...
```bash
# 1. Fork on GitHub: https://github.com/achiando/tijwa-wacrm → Fork
# 2. Clone your fork
...
```bash
git remote add upstream https://github.com/achiando/tijwa-wacrm.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/achiando/tijwa-wacrm/issues/new?template=bug_report.yml)
...
- Rebrand. The "CRM Template for WhatsApp" name, favicon, and
   `tijwa-crm.tijwa.com` URL belong to the upstream project; please swap them
