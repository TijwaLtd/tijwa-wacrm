...
- [GitHub Security Advisories](https://github.com/achiando/tijwa-wacrm/security/advisories/new)
  (preferred — keeps the disclosure, fix, and CVE all in one place).
- Email: `security@tijwa.com` with `[CRM template security]` in the subject.
...
In scope:
- Anything in this repository (`achiando/tijwa-wacrm`), including webhook and auth
